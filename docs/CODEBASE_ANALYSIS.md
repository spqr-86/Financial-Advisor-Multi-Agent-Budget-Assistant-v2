...
2.  `prompts/agents/` — текстовые промпты, объясняющие AI его роль.
3.  `src/mcp/agents/tools/` — Python-функции, которые AI может вызывать (Tools).
...
*   AI подхватит изменение автоматически (словарь инжектится в промпт).
